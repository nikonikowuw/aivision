...
import (
	...
	"niko-vue-admin/app/internal/proto/aivision/v1"
...
func (f *fakeEngineService) QueryProfile(context.Context, *aivisionv1.QueryProfileRequest) (*aivisionv1.QueryProfileResponse, error) {
	return &aivisionv1.QueryProfileResponse{Profile: &aivisionv1.PlatformProfileInfo{PlatformId: "fake"}}, nil
}
...
func TestLifecycleGracefulShutdown(t *testing.T) {
	...
	esrv := grpc.NewServer()
	aivisionv1.RegisterEngineServiceServer(esrv, &fakeEngineService{})
