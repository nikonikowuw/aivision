...
func NewEngineClient(cfg *config.Config) (*EngineClient, error) {
	...
	return &EngineClient{raw: aivisionv1.NewEngineServiceClient(conn), conn: conn}, nil
}
...
func (c *EngineClient) ApplyDesiredState(ctx context.Context, req *aivisionv1.ApplyDesiredStateRequest, opts ...grpc.CallOption) (*aivisionv1.ApplyDesiredStateResponse, error) {
	return call(c.raw.ApplyDesiredState, ctx, req, opts...)
}

// UpsertTask 新增或更新单摄像头任务。
func (c *EngineClient) UpsertTask(ctx context.Context, req *aivisionv1.UpsertTaskRequest, opts ...grpc.CallOption) (*aivisionv1.UpsertTaskResponse, error) {
	return call(c.raw.UpsertTask, ctx, req, opts...)
}

// SetInstanceState 设置算法实例启用状态。
func (c *EngineClient) SetInstanceState(ctx context.Context, req *aivisionv1.SetInstanceStateRequest, opts ...grpc.CallOption) (*aivisionv1.SetInstanceStateResponse, error) {
	return call(c.raw.SetInstanceState, ctx, req, opts...)
}

// UpdateInstanceConfig 热更新实例配置。
func (c *EngineClient) UpdateInstanceConfig(ctx context.Context, req *aivisionv1.UpdateInstanceConfigRequest, opts ...grpc.CallOption) (*aivisionv1.UpdateInstanceConfigResponse, error) {
	return call(c.raw.UpdateInstanceConfig, ctx, req, opts...)
}

// InstallPackage 安装算法包。
func (c *EngineClient) InstallPackage(ctx context.Context, req *aivisionv1.InstallPackageRequest, opts ...grpc.CallOption) (*aivisionv1.InstallPackageResponse, error) {
	return call(c.raw.InstallPackage, ctx, req, opts...)
}

// UpgradePackage 升级算法包。
func (c *EngineClient) UpgradePackage(ctx context.Context, req *aivisionv1.UpgradePackageRequest, opts ...grpc.CallOption) (*aivisionv1.UpgradePackageResponse, error) {
	return call(c.raw.UpgradePackage, ctx, req, opts...)
}

// RollbackPackage 回滚算法包版本。
func (c *EngineClient) RollbackPackage(ctx context.Context, req *aivisionv1.RollbackPackageRequest, opts ...grpc.CallOption) (*aivisionv1.RollbackPackageResponse, error) {
	return call(c.raw.RollbackPackage, ctx, req, opts...)
}

// UninstallPackage 卸载算法包。
func (c *EngineClient) UninstallPackage(ctx context.Context, req *aivisionv1.UninstallPackageRequest, opts ...grpc.CallOption) (*aivisionv1.UninstallPackageResponse, error) {
	return call(c.raw.UninstallPackage, ctx, req, opts...)
}

// DeleteImages 请求 Engine 删除图片。
func (c *EngineClient) DeleteImages(ctx context.Context, req *aivisionv1.DeleteImagesRequest, opts ...grpc.CallOption) (*aivisionv1.DeleteImagesResponse, error) {
	return call(c.raw.DeleteImages, ctx, req, opts...)
}

// ReconcileImages 推送 Go 权威保留的图片 ID 集合供 Engine 对账。
func (c *EngineClient) ReconcileImages(ctx context.Context, req *aivisionv1.ReconcileImagesRequest, opts ...grpc.CallOption) (*aivisionv1.ReconcileImagesResponse, error) {
	return call(c.raw.ReconcileImages, ctx, req, opts...)
}

// QueryProfile 查询平台能力档案。
func (c *EngineClient) QueryProfile(ctx context.Context, req *aivisionv1.QueryProfileRequest, opts ...grpc.CallOption) (*aivisionv1.QueryProfileResponse, error) {
