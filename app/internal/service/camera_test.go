...
type fakeProbeClient struct {
	...
	onCall func(ctx context.Context, req *aivisionv1.ProbeCameraRequest) (*aivisionv1.ProbeCameraResponse, error)
	calls  int
}

func (f *fakeProbeClient) ProbeCamera(ctx context.Context, req *aivisionv1.ProbeCameraRequest, _ ...grpc.CallOption) (*aivisionv1.ProbeCameraResponse, error) {
	f.calls++
	if f.onCall != nil {
...
func probeSuccessResp() *aivisionv1.ProbeCameraResponse {
	return &aivisionv1.ProbeCameraResponse{
...
func probeFailureResp(code string) *aivisionv1.ProbeCameraResponse {
	return &aivisionv1.ProbeCameraResponse{
...
func TestCameraServiceProbePersistsSuccessOnFingerprintMatch(t *testing.T) {
	...
	fake.onCall = func(_ context.Context, req *aivisionv1.ProbeCameraRequest) (*aivisionv1.ProbeCameraResponse, error) {
...
func TestCameraServiceProbeFingerprintMismatchIsStale(t *testing.T) {
	...
	fake.onCall = func(_ context.Context, _ *aivisionv1.ProbeCameraRequest) (*aivisionv1.ProbeCameraResponse, error) {
