...
func InitializeApp(cfg *config.Config) (*App, error) {
	wire.Build(
		...
		repository.NewFaceObservationRepository,
		service.NewFaceObservationService,
		api.NewFaceObservationHandler,
		repository.NewFaceCaptureRepository,
		service.NewFaceCaptureService,
		api.NewFaceCaptureHandler,
		repository.NewCaptureRepository,
		service.NewCaptureService,
		api.NewCaptureHandler,
		storage.NewDiskUsageSampler,
		service.NewStorageCleanupServiceWithCaptures,
		api.NewStorageHandler,
		service.NewReportAdapterWithCaptures,
		api.NewTaskHandler,
