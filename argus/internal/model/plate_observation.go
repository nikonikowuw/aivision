...
type PlateObservation struct {
	...
	AlgorithmID       string                `gorm:"column:algorithm_id;size:64;not null;default:'';index:idx_plate_observations_algorithm_id" json:"algorithmId"`
	...
	ImageID           string                `gorm:"column:image_id;size:200;not null;default:'';index:idx_plate_observations_image_id" json:"imageId"`
	ImageRelPath      string                `gorm:"column:image_rel_path;size:255;not null;default:''" json:"imageRelPath"`
	PlateImageID      string                `gorm:"column:plate_image_id;size:200;not null;default:'';index:idx_plate_observations_plate_image_id" json:"plateImageId"`
	PlateImageRelPath string                `gorm:"column:plate_image_rel_path;size:255;not null;default:''" json:"plateImageRelPath"`
