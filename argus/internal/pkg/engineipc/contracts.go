...
func (unavailableDesiredStateAdapter) DesiredState(context.Context, uint64) (*argusv1.DesiredState, error) {
...
func (unavailableReportAdapter) AcceptTaskState(context.Context, *argusv1.TaskState) error {
	return NewAdapterError(CodeIPCUNAVAILABLE, "report service unavailable")
}

func (unavailableReportAdapter) AcceptInstanceState(context.Context, *argusv1.InstanceState) error {
	return NewAdapterError(CodeIPCUNAVAILABLE, "report service unavailable")
}

func (unavailableReportAdapter) AcceptMetrics(context.Context, *argusv1.DeviceTelemetry) error {
	return NewAdapterError(CodeIPCUNAVAILABLE, "report service unavailable")
}

func (unavailableReportAdapter) ReconcileOrphanImages(context.Context, []*argusv1.OrphanImageEntry) (OrphanDisposition, error) {
