...
type ProfileClient interface {
	QueryProfile(ctx context.Context, req *argusv1.QueryProfileRequest, opts ...grpc.CallOption) (*argusv1.QueryProfileResponse, error)
}
...
func (q *quotaManager) fetch() error {
	...
	defer cancel()
	resp, err := q.client.QueryProfile(ctx, &argusv1.QueryProfileRequest{})
	if err != nil {
