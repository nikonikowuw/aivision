...
<template>
  ...
  >
    <div v-if="algorithm" class="space-y-4 py-1">
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              <div class="flex items-center gap-2">
                ...
                <Tag v-else color="blue" class="rounded-full px-2 text-xs">
                  {{ $t('ai.algorithm.sourceCustom') }}
                </Tag>
              </div>
              <div
                class="mt-1 flex items-center gap-2 font-mono text-xs text-muted-foreground"
              >
                ...
                >
                  {{ $t('ai.algorithm.activeVersion') }}: v{{
                    algorithm.activeVersion || '-'
                  }}
                </span>
              </div>
            </div>
      ...
      <Empty
        v-else
        :description="$t('ai.algorithm.noVersions')"
        class="py-12"
      />
    </div>
  </Drawer>
