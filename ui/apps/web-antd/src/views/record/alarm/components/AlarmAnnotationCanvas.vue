  ...
  <div class="flex flex-col gap-2">
    ...
    >
      ...
      >
        ...
        <div class="relative inline-flex max-h-[500px] max-w-full items-center justify-center overflow-hidden rounded">
          <!-- 底图 -->
          <img
            :src="imageSrc"
            alt="Alarm snapshot"
          ...
          >
            ...
            >
              ...
              />
              <!-- 目标顶部标签底色与文字 -->
              <g :transform="`translate(${getBBoxCoords(props.detail.bbox).x}, ${Math.max(0, getBBoxCoords(props.detail.bbox).y - 26)})`">
                <rect
                  :width="Math.max(120, (props.detail.targetLabel || 'Target').length * 9 + 68)"
                  height="24"
                  rx="4"
